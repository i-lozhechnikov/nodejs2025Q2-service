...
export class Version1748895875705 implements MigrationInterface {
  name = 'Version1748895875705';
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `CREATE TABLE "favorites" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "artists" text array NOT NULL DEFAULT '{}', "albums" text array NOT NULL DEFAULT '{}', "tracks" text array NOT NULL DEFAULT '{}', CONSTRAINT "PK_890818d27523748dd36a4d1bdc8" PRIMARY KEY ("id"))`,
    );
    await queryRunner.query(
      `INSERT INTO "favorites" ("artists", "albums", "tracks") VALUES ('{}', '{}', '{}')`,
    );
  }
